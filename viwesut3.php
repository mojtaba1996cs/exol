...
<title>طلاب المستوي الثاني </title>
...
<div id="y_vist"><div id="y2_vist">&nbsp;&nbsp;&nbsp;طلاب المستوي الثاني &nbsp;&nbsp;</div>
&nbsp;|<a href="viwesut.php"><div id="y2_vist">&nbsp;&nbsp;رجوع  &nbsp;&nbsp;</div></a>
 &nbsp;|<a href="res.php?x=المستوي الثاني&y=viwesut3.php"><div id="y2_vist">&nbsp;&nbsp;&nbsp;بحث عن طالب&nbsp;&nbsp;&nbsp;</div></a>
...
$startpoint = ($page * $limit) - $limit;
 $statement = "`".$db_name."`.`students` where Std_level='المستوي الثاني' and Std_status=1";
  $sql= mysqli_query($connect,"SELECT * FROM {$statement}  LIMIT {$startpoint},$limit" );
  $sql2 = "SELECT * FROM  students where Std_level='المستوي الثاني' and Std_status=0 ";
$result2 = $connect-> query($sql2);
echo '<div id="post_vist">';
if($sql-> num_rows > 0){
 $t=0;
 $t2=0;
echo"<br><table class='table_vist'><tr id='tr_vist'><th style='width:60px' id='id' class='th_vist'>#</th>
...
'&nbsp;&nbsp;&nbsp;<a href="stop2.php?id='.$Std_id.'&name='.$Std_name.'&std_set='.$Std_set.'"><center><input type="button" id="stop" value="توقف"></center></a></td></tr>';
}
echo"</table>";
...
echo"<br><hr><br>";
echo" <a href='#'><div id='tt_vist'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; طلاب لديهم ملاحق  &nbsp;&nbsp;</div></a>";
...
<td style="width:90px" dir="ltr" id="set" class="td_vist">'.$Std_set.'</td>
<td style="width:250px" id="am" class="td_vist">'.
'&nbsp;&nbsp;&nbsp;<a href="cont2.php?id='.$Std_id.'&name='.$Std_name.'"><center><input type="button" id="atv" value="تنشيط"></center></a></td></tr>';
}
echo"</table>";
echo '<p></p>';
echo '<p></p>';
...
function removeclass(){
  window.location.href="fupdatesut.php";
    }

   function removelevel(){
  window.location.href="fupdatesut2.php";
    }
</script>';
  ?>
</form>
