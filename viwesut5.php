...
<title>طلاب المستوي الرابع </title>
...
<div id="header"><img src="img/rr3.jpg" width="185" height="185" alt="جامعة دنقلا" id="img"/></div><hr>
  <div id="y_vist"><div id="y2_ad">&nbsp;&nbsp;&nbsp;طلاب المستوي الرابع &nbsp;&nbsp;</div>
    &nbsp;|<a href="viwesut.php"><div id="y2_vist">&nbsp;&nbsp;رجوع  &nbsp;&nbsp;</div></a>
 &nbsp;|<a href="res.php?x=المستوي الرابع&y=viwesut5.php"><div id="y2_vist">&nbsp;&nbsp;بحث عن طالب&nbsp;&nbsp;</div></a>
...
$startpoint = ($page * $limit) - $limit;
 $statement = "`".$db_name."`.`students` where Std_level='المستوي الرابع' and Std_status=1";
  $sql= mysqli_query($connect,"SELECT * FROM {$statement}  LIMIT {$startpoint},$limit" );
$result = $connect-> query($sql);
  $sql2 = "SELECT * FROM  students where Std_level='المستوي الرابع' and Std_status=0 ";
...
'&nbsp;&nbsp;&nbsp;<a  href="stop4.php?id='.$Std_id.'&name='.$Std_name.'"><center><input type="button" id="stop" value="توقف"></center></a></td></tr>';
}
echo"</table>";
echo'<div class="footer-copyright2_vist">
 <div id="button_vist"> <input type="button" value="نقل  الكل  الي الفصل التالي"  onclick="removeclass()" id="on"></div>';
...
<td style="width:90px" dir="ltr" id="set" class="td_vist">'.$Std_set.'</td>
<td style="width:250px" id="am" class="td_vist">'.
'&nbsp;&nbsp;&nbsp;<a href="cont4.php?id='.$Std_id.'&name='.$Std_name.'"><center><input type="button" id="atv" value="تنشيط"></center></a>';
}
echo"</table>";
echo '<p></p>';
echo '<p></p>';
...
function removeclass(){
  window.location.href="foupdatesut.php";
    }
</script>';
