...
$d=($_GET['page']);
 ...
 $sql7=mysqli_query($connect,"SELECT * from questions where test_id='$id_test' and `type_Qu`='one' and deg_qu=1");               $deg3=mysqli_num_rows($sql7);
$sql8=mysqli_query($connect,"SELECT * from questions where test_id='$id_test' and `type_Qu`='one' and deg_qu=1");
       $sql10 =mysqli_query($connect,"SELECT * from questions where test_id='$id_test' and `type_Qu`='eoc' and deg_qu=1");
     if($deg3 > $deg2){
       echo '<div class="exam2">';
     }
     else{
       echo '<div class="exam">';
echo'<center> <div><table><tr><td><center>جامعة دنقلا</center></td></tr>
 <tr><td><center>كلية علوم الحاسوب والتنمية البشرية</center></td></tr>
 <tr><td><center> لجنة امتحانات الدور الاول _دورة '.$date=date("Y-M").'
</center></td></tr><tr><td><center>'.$class.'– بكالريوس '.$specialty.'
...
<table id="input"><tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><td><b id="n">الاسم:</b></td><td><input type="text" name="std_name" id="textfield" value="'.$std_name.'" disabled ></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b id="n">رقم الجلوس:</b></td><td><input type="text" name="std_set" id="textfield" value='.$id2.' disabled></td></tr></table>
      <div id="header2">
    <table><tr><td></td><td></td><td>التاريخ:</td> <td>'.$date2.'</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>المادة:</td> <td>'.$test_name.'</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>الزمن:</td> <td>'.$time.'ساعات</td>
       </tr>
</table></div>
...
$page = (int) (!isset($_GET["page"]) ? 1: $_GET["page"]);
 ...
 if($sql4-> num_rows >0){
 echo '<table><tr><td id="Qu">السؤال '.$name_Qu.' :اختر الاجابات  الصحيحة</td><td><hr><hr></td><hr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr></table><hr>';
...
$ans4=$result4['ans4'];
 $image=$result4['image'];
 echo'<form name="test" action="answer2.php?session='.$session.'&Qu='.$Qu.'&type='.$type.'&d='.$d.'&nameQu='.$name_Qu.'&page='.$page.'" method="post">';
if(!empty($image)){
echo'<div class="container">
<div id="Qu2"><table><tr><td>'.$d.'/'.$Qu.'</td></tr><tr><td><img src=img/imgQu/'.$image.' height="220" width="780"></td></tr></table></div></div>';
}else{
  echo'<div class="container"><div id="Qu3"><table><tr><td>'.$d.'/'.$Qu.'</td></tr><tr><td></td></tr></table></div></div>';
}
  echo'<div class="ul"><ul dir="ltr">';
    if(!empty($ans1)){
 echo'<li>
    <input type="checkbox" value="'.$ans1.'"  id="f-option" name="ans1">
  ...
  if(!empty($ans2)){
  echo '<li>
    <input type="checkbox" value="'.$ans2.'"  id="s-option" name="ans2">
...
if(!empty($ans3)){
 echo '<li>
    <input type="checkbox" value="'.$ans3.'"  id="t-option" name="ans3">
    <label for="t-option"><b>'.$ans3.'</b></label>
    <div class="check"><div class="inside"></div></div></li> ';
  }else{
}
 if(!empty($ans4)){
 echo'<li> <input type="checkbox" value="'.$ans4.'"  id="v-option" name="ans4">
...
<?php
     ...
     if($sql10-> num_rows <= 0 && $sql8 -> num_rows <= 0){
...
echo '<table id="nameT"><tr><td>استاذ المادة:'.$T_name.'</td></tr></table>';
       echo"<hr>";
       echo "<table><td><a href='deg.php?session=".$session."&casesut=comp' id='save3'>معرفة النتيجة</a></td></tr></table>";
       echo "<hr>";
       include "index2.php";
       echo '<br>';
       echo "<hr>";
 echo "<div><center>1</center></div>";
     }elseif($deg3 > $deg2 && $sql10 -> num_rows <=0){
echo '<center><table><tr><td style="font-size:30px;">تم بحمدلله☻</td></tr></table></center>';
echo '<table id="nameT"><tr><td>استاذ المادة:'.$T_name.'</td></tr></table>';
  echo '<hr>';
...
echo "<div><center>2</center></div>";
     ...
     if($deg3 >$deg2){
  echo "<table><tr><td><a href='en_test.php?session=".$session."&page=1&nameQu=الاول' id='save2'>««الصفحة السابقة</a></td><td><a href='sut_test2.php?session=".$session."&page=1&nameQu=التالث' id='save4'>الصفحة التالية»»</td></tr></table>";
       echo "<hr>";
       include "index2.php";
       echo '<br>';
       echo "<hr>";
echo "<div><center>2</center></div>";
       ...
       echo "<table><tr><td><a href='en_test.php?session=".$session."&page=1&nameQu=الثاني' id='save3'>الصفحة التالية</a></td></tr></table>";
       echo "<hr>";
       include "index2.php";
       echo '<br>';
       echo "<hr>";
echo "<div><center>1</center></div>";
     }}elseif($sql10-> num_rows >0){
            echo "<table><tr><td><a href='sut_test2.php?session=".$session."&page=1&nameQu=الثاني' id='save3'>الصفحة التالية»»</a></td><td></td></tr></table>";
       echo "<hr>";
       include "index2.php";
       echo '<br>';
       echo '<hr>';
...
var msg = "زمن الامتحان انتهاء سيتم تحويك الي صفحة النتيجة.. اضغظ موافق للدخول الي صفحة النتيجة";
