...
<title>مواد المستوي الاول </title>
...
include"cont.php";
  ...
  $c=0;
  $d=0;
$sql = "SELECT * FROM  material where Class='الفصل الاول' and Specialty='IT'";
$result = $connect-> query($sql);
  $sql2 = "SELECT * FROM  material  where Class='الفصل الثاني' and Specialty='IT'";
$result2 = $connect-> query($sql2);
$sql3= "SELECT * FROM  material where Class='الفصل الاول' and Specialty='CS'";
$result3= $connect-> query($sql3);
  $sql4 = "SELECT * FROM  material  where Class='الفصل الثاني' and Specialty='CS'";
...
echo'<br><center><div id="h2_mat">'. 'لاتوجد مادة  '.'</div></center>';
}
echo "<br><hr id='hr2_mat'><div id='div_mat'></div><hr id='hr2_mat'>";
 echo" <a href='#'><div id='h_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  مواد الفصل الثاني  &nbsp;&nbsp;</div></a>";
 echo"<br><center><a href='#'><div id='t_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;تخصص تقنية معلومات  &nbsp;&nbsp;</div></a></center>";
