...
<title>طلاب المستوي الثالث </title>
...
<div id="y_vist"><div id="y2_vist">&nbsp;&nbsp;&nbsp;طلاب المستوي الثالث &nbsp;&nbsp;</div>
&nbsp;|<a href="viwesut.php"><div id="y2_vist">&nbsp;&nbsp;رجوع  &nbsp;&nbsp;</div></a>
&nbsp;|<a href="res.php?x=المستوي الثالث&y=viwesut4.php"><div id="y2_vist">&nbsp;&nbsp;&nbsp;بحث عن طالب&nbsp;&nbsp;&nbsp;</div></a>
...
$startpoint = ($page * $limit) - $limit;
 $statement = "`".$db_name."`.`students` where Std_level='المستوي الثالث' and Std_status=1";
  $sql= mysqli_query($connect,"SELECT * FROM {$statement}  LIMIT {$startpoint},$limit" );
  $sql2 = "SELECT * FROM  students where Std_level='المستوي الثالث' and Std_status=0 ";
...
'&nbsp;&nbsp;&nbsp;<a href="stop3.php?id='.$Std_id.'&name=' .$Std_name.'"><center><input type="button" id="stop" value="توقف"></center></a></td></tr>';
}
echo"</table>";
...
echo "<div id='t_vist'><table id='table2_vist'><tr id='tr2_vist'><td id='td2_vist'>لايوجد طلاب في هذا المستوي</tr></td></table></div>";
 ...
 echo"<br><hr><br>";
 echo"<div id='tt_vist'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; طلاب لديهم ملاحق  &nbsp;&nbsp;</div></a>";
...
<td style="width:90px" dir="ltr" id="set" class="td_vist"> &nbsp;'.$Std_set.'</td>
<td style="width:250px" id="am" class="td_vist">'.
'&nbsp;&nbsp;&nbsp;<a href="cont3.php?id='.$Std_id.'&name='.$Std_name.'"><center><input type="button" id="atv" value="تنشيط"></center></a></td></tr>';
}
echo"</table>";
echo '<p></p>';
echo '<p></p>';
...
function removeclass(){
  window.location.href="cupdatesut.php";
    }
function removelevel(){
  window.location.href="cupdatesut2.php";
    }
</script>';
  ?>
</form>
