...
<title>مواد المستوي الثالث </title>
...
include"cont.php";
  ...
  $c=0;
  $d=0;
$sql = "SELECT * FROM  material where Class='الفصل الخامس' and Specialty='IT'";
$result = $connect-> query($sql);

$sql2 = "SELECT * FROM  material  where Class='الفصل السادس' and Specialty='IT'";
$result2 = $connect->query($sql2);

 $sql3= "SELECT * FROM  material where Class='الفصل الخامس' and Specialty='CS'";
$result3= $connect-> query($sql3);

 $sql4 = "SELECT * FROM  material  where Class='الفصل السادس' and Specialty='CS'";
...
echo" <div  id='h_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  مواد الفصل السادس  &nbsp;&nbsp;</div><br>";
 echo"<center><a href='#'><div id='t_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;تخصص تقنية معلومات  &nbsp;&nbsp;</div></a></center>";
