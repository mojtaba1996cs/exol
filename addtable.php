...
<div id="header"><img src="img/rr3.jpg" width="185" height="185" alt="جامعة دنقلا" id="img"/>
  ...
  <div id="y_ad"><div id="y2_ad">اضافة امتحان</div>|<a href="reg_admin.php"><div id="y2_ad">&nbsp;رجوع&nbsp;</div></a>|<a href="viwetable.php"><div id="y2_ad">&nbsp;عرض جدول الامتحانات&nbsp;</div></a>
&nbsp;|<div id="y2_ad">&nbsp;<?php include "time2.php"; ?>&nbsp;</div></div>
  <div id="post_ad">
<form  name ="add"  action="addtable_sa.php" method="post"  class="qaab5">
<center><br><br>
<table>
<tr>
<td>
<a href="addtable2.php?sp=CS"><div id="viwe_adta"> تخصص علوم حاسوب </div></a>
</td>
<td>
<a href="addtable2.php?sp=IT"><div id="viwe_adta">  تخصص تقنية معلومات </div></a></td>
</tr></table></center>
</form>
    </div>
<aside id='aside_ad'>
