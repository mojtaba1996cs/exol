...
<title>مواد المستوي الرابع </title>
...
include"cont.php";
  ...
  $c=0;
  $d=0;
$sql = "SELECT * FROM  material where Class='الفصل السابع' and Specialty='IT'";
$result = $connect-> query($sql);

$sql2 = "SELECT * FROM  material  where Class='الفصل الثامن' and Specialty='IT'";
$result2 = $connect->query($sql2);

 $sql3= "SELECT * FROM  material where Class='الفصل السابع' and Specialty='CS'";
$result3= $connect-> query($sql3);

 $sql4 = "SELECT * FROM  material  where Class='الفصل الثامن' and Specialty='CS'";
$result4 = $connect-> query($sql4);
echo"<center><a href='#'><div id='t_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;تخصص تقنية معلومات  &nbsp;&nbsp;</div></a></center>";
...
echo"<div id='h_mat'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  مواد الفصل الثامن  &nbsp;&nbsp;</div>";
...
echo'<center><div id="h2_mat">'. 'لاتوجد مادة  '.'</b></center><br>';
}
  $connect->close();
  ob_end_flush();
  echo "<br><br>";
