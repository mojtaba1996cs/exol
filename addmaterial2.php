...
<div id="header"><img src="img/rr3.jpg" width="185" height="185" alt="جامعة دنقلا" id="img"/>
  ...
  <div id="y_ad"><div id="y2_ad">&nbsp;اضافة مادة  &nbsp;</div>&nbsp;|<a href="addmaterial.php"><div id="y2_ad">&nbsp;&nbsp;رجوع&nbsp;&nbsp;</div></a>
   &nbsp;|<div id="y2_ad">&nbsp;<?php include "time2.php"; ?></div></div>
  <div id="post_ad">
<form  name ="add"  action="addmaterial_sa.php" method="post"  class="qaab5" enctype="multipart/form-data">

<center>
<table>
<input type="hidden" name="id">
  <input type="hidden" name="class" value="<?php echo $class;?>">
    <input type="hidden" name="specialty" value="<?php echo $spe;?>">
  <br>
  <tr>
  <td width="203"><h4 class="labe_adus"><center>اسم المادة </center></h4></td>
  <td><b class="mint-tips" data-title="ادخل اسم المادة " ><input type="text" name="name" type="text" id="textfield_adus" placeholder="ادخل اسم المادة"></b></td>
</tr>
  <tr>
    <td><h4 class="labe_adus"><center>زمن الامتحان </center></h4>
    </td>
    <td><b class="mint-tips" data-title="اختار عدد ساعات الامتحان" ><select name="time" id="textfield_adus">
      <option value="2">ساعتين</option>
      <option value="3">ثلاث ساعات </option>
      </select>
    </b></td></tr>
<tr><td><h4 class="labe_adus"><center>استاذ المادة</center></h4></td> <td>
<b class="mint-tips" data-title="اختار استاذ المادة" ><select name="Teacher" id="textfield_adus"  size="16">
<?php
include"cont.php";
  $sql = "SELECT * FROM teachers  where T_level='Teacher' ";
  $result = $connect-> query ($sql);
		if ($result-> num_rows > 0 ){
			while ($tableRow = $result->fetch_array()) {
              $name=$tableRow['T_name'];
              $name2=explode(",",$name);
